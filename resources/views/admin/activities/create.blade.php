                    ...
                    <form action="{{ route('activities.store') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select @error('category_type_id') is-invalid @enderror"
                                        ...
                                        @foreach($categoryTypes as $categoryType)
                                            <option value="{{ $categoryType->id }}" {{ old('category_type_id') == $categoryType->id ? 'selected' : '' }}>
                                                {{ $categoryType->name }} ({{ $categoryType->mainCategory->name ?? 'N/A' }})
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="form-check form-check-inline mt-2">
                                        <input class="form-check-input" type="checkbox"
                                            id="is_family_friendly" name="is_family_friendly" value="1"
                                            {{ old('is_family_friendly') ? 'checked' : '' }} />
                                        <label class="form-check-label" for="is_family_friendly">Family Friendly</label>
                                    </div>
                                    <div class="form-check form-check-inline mt-2">
                                        <input class="form-check-input" type="checkbox"
                                            id="is_accessible" name="is_accessible" value="1"
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('description') is-invalid @enderror"
                                ...
                                placeholder="Enter activity description" required>{{ old('description') }}</textarea>
                            @error('description')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
